...
def generate_jeopardy_game():
    try:
        ...
        jeopardy_game = {
            ...
            'questions': {
                'Basic Concepts': [
                    {'points': 100, 'question': f'What is a fundamental principle of {topic}?', 'answer': ''},
                    {'points': 200, 'question': f'Name a key component of {topic}', 'answer': ''},
                    {'points': 300, 'question': f'How is {topic} used in everyday life?', 'answer': ''}
                ],
                'Definitions': [
                    {'points': 100, 'question': f'Define this term related to {topic}', 'answer': ''},
                    {'points': 200, 'question': f'What does this {topic} vocabulary mean?', 'answer': ''},
                    {'points': 300, 'question': f'Explain this advanced {topic} concept', 'answer': ''}
                ]
            },
            'gameSettings': {
                'timeLimit': 30,
